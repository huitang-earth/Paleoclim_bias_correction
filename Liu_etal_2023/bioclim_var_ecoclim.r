...
setwd("/home/huitang/Documents/data/Paleo_bioclim/EcoClim")

fprec<-nc_open("wc2.0_10m_prec_ecoclim_plio.nc")
prec<-ncvar_get(fprec,"Band1")
ftavg<-nc_open("wc2.0_10m_tavg_ecoclim_plio.nc")
tavg<-ncvar_get(ftavg,"Band1")
ftmax<-nc_open("wc2.0_10m_tmax_ecoclim_plio.nc")
tmax<-ncvar_get(ftmax,"Band1")
ftmin<-nc_open("wc2.0_10m_tmin_ecoclim_plio.nc")
...
nc = nc_create( "bioclim_ecoclim_plio.nc", bioclim )
